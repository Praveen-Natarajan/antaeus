...
fun ResultRow.toAudit(): Audit = Audit(
        id = this[AuditTable.id],
        fromstatus = this[AuditTable.fromstatus],
        toStatus = this[AuditTable.tostatus],
        timestamp = this[AuditTable.timestamp].toDate()
)
